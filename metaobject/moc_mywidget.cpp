...
**
** Created: Sat May 15 12:51:28 2010
...
static const char qt_meta_stringdata_MyWidget[] = {
    "MyWidget\0\0,\0onShow(int,int)\0"
    "responseToShow(int,int)\0QString\0title\0"
};
...
int MyWidget::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: onShow((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 1: responseToShow((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
        _id -= 2;
    }
...
// SIGNAL 0
void MyWidget::onShow(int _t1, int _t2)
{
